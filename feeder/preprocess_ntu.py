...
from feeder.NTUDatasets import NTUMotionProcessor
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='data/ntu60/NTU60_frame50')
    #parser.add_argument('--out_folder', default='data/ntu120/NTU120_frame50')
