...
if __name__ == '__main__':
    ...
    processors['pretrain_crosscale_sgclr'] = import_class('processor.pretrain_crosscale_sgclr.CrosScale_SGCLR_Processor')
    processors['pretrain_crosview_sgclr'] = import_class('processor.pretrain_crosview_sgclr.CrosView_SGCLR_Processor')
    processors['pretrain_sgclr'] = import_class('processor.pretrain_sgclr.SGCLR_Processor')
